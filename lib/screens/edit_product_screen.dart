...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  var _initValues = {//store the init values in a map
    'title': '',
    'description': '',
    'price': '',
    'imageUrl': '',
  ...
  void didChangeDependencies() {
    ...
    _isInit = false;//didChangeDependencies will change a lot =>we just need to do this once
  ...
  void _saveForm() {
    final isValid = _form.currentState.validate();//true if all validatpors return null
    if (!isValid) {
      return;
    }
    _form.currentState.save(); //use a key when we need to interact with a widget from inside here(mostly used by form widgets)
    //save method provided by the state object of form widget
          ...
          child: ListView(
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Title'),//can configure error message style),
                textInputAction: TextInputAction.next, //controls what the bottom right keyboard button will do
                onFieldSubmitted: (_) {
