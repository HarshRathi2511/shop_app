...
enum AuthMode { Signup, Login } //for different modes
                  ...
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-8 *
                          pi /
                          180) //transformation matrix to apply before painting the container
                        //rotation of radians around Z axis
                        ..translate(
                            -10.0), //add offset config =>transalte returns void
                      // .. operator calls translate calls the object on the Matrix class but doesnt return
                      //its return type which is void
...
class _AuthCardState extends State<AuthCard> {
  ...
  AuthMode _authMode = AuthMode.Login; //initial state
              ...
              children: <Widget>[
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    return null; //if evrything goes fine
                  },
                  onSaved: (value) {
                ...
                TextFormField(
                  ...
                  obscureText: true, //dont show text
